...
gr.ChatInterface(ragger.generate_response, title = "🌭🍗 philly's food places 🍣🍔", examples = ["Where could I get some good Mexican food in philadelphia?", "What is the best pizza in town?", "Give me some healthy dining options nearby."], theme="Jameswiller/Globe", submit_btn = None, stop_btn = None, retry_btn = None, undo_btn = None, clear_btn = None).launch()